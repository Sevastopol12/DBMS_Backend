...
_db_loader: Callable[[], Any] | None = None
...
def _build_default_gateway() -> MappingLookupGateway:
    if _db_loader is None:
        raise RuntimeError("mapping gateway database loader is not configured")
...
def get_mapping_gateway(
    *, db_loader: Callable[[], Any] | None = None
